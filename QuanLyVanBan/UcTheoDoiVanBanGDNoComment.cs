...
{
    public partial class UcTheoDoiVanBanDenGDNoComment : DevExpress.XtraEditors.XtraUserControl
    {
        QuanLyCongViecEntities quanLyCongViecEntities;
        private static UcTheoDoiVanBanDenGDNoComment _ucTheoDoiVanBanGDNoComment;
        public static UcTheoDoiVanBanDenGDNoComment ucTheoDoiVanBanGDNoComment
        {
            get
            {
                if (_ucTheoDoiVanBanGDNoComment == null)
                    _ucTheoDoiVanBanGDNoComment = new UcTheoDoiVanBanDenGDNoComment();
                return _ucTheoDoiVanBanGDNoComment;
            }
        }
        public UcTheoDoiVanBanDenGDNoComment()
        {
            InitializeComponent();
        }
        ...
        private void GetAllGDVanBanDen()
        {
            try
            {
                ...
                {
                    var _GetAllGDVanBanDen = quanLyCongViecEntities.ViewGDVanBanDenGDNoComment().ToList();
