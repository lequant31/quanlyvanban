...
{
    public partial class UcTheoDoiVanBanDenSapHetHan : DevExpress.XtraEditors.XtraUserControl
    {
        QuanLyCongViecEntities quanLyCongViecEntities;
        private static UcTheoDoiVanBanDenSapHetHan _UcTheoDoiVanBanDenSapHetHan;
        public static UcTheoDoiVanBanDenSapHetHan UcTheoDoiVanBanDenSapHet
        {
            get
            {
                if (_UcTheoDoiVanBanDenSapHetHan == null)
                    _UcTheoDoiVanBanDenSapHetHan = new UcTheoDoiVanBanDenSapHetHan();
                return _UcTheoDoiVanBanDenSapHetHan;
            }
        }
        public UcTheoDoiVanBanDenSapHetHan()
        {
            InitializeComponent();
        }
        private void GetAllGDVanBanDen()
        {
            try
            {
                ...
                {
                    var _GetAllGDVanBanDen = quanLyCongViecEntities.ViewGDVanBanDenSapHetHan().ToList();
