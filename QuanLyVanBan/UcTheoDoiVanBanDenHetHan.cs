...
{
    public partial class UcTheoDoiVanBanDenHetHan : DevExpress.XtraEditors.XtraUserControl
    {
        QuanLyCongViecEntities quanLyCongViecEntities;
        private static UcTheoDoiVanBanDenHetHan _UcTheoDoiVanBanDenHetHan;
        public static UcTheoDoiVanBanDenHetHan ucTheoDoiVanBanDenHetHan
        {
            get
            {
                if (_UcTheoDoiVanBanDenHetHan == null)
                    _UcTheoDoiVanBanDenHetHan = new UcTheoDoiVanBanDenHetHan();
                return _UcTheoDoiVanBanDenHetHan;
            }
        }
        public UcTheoDoiVanBanDenHetHan()
        {
            InitializeComponent();
        }
        private void GetAllGDVanBanDen()
        {
            try
            {
                ...
                {
                    var _GetAllGDVanBanDen = quanLyCongViecEntities.ViewGDVanBanDenHetHan().ToList();
